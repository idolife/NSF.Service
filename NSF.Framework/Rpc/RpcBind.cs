...
namespace NSF.Framework.Rpc
{
    ...
    class RpcUtil
    {
        ...
        public static DataBlock EncodeRpcCallInfo(RpcCallInfo info, DataBlock buff)
        {
        ...
        public static RpcCallInfo DecodeRpcCallInfo(DataBlock block)
        {
        ...
        public static DataBlock EncodeRpcRespInfo(RpcRespInfo resp, DataBlock buff)
        {
        ...
        public static RpcRespInfo DecodeRpcRespInfo(DataBlock buff)
        {
